...
export type PluginHookHandler<T extends Hooks = Hooks> = (payload: T extends keyof HookPayloadMap ? HookPayloadMap[T] : unknown) => void | Promise<void>;
...
export interface PluginAppState {
    readonly tasks: Readonly<{
        [id: string]: Readonly<Task>;
    }>;
    readonly projects: Readonly<{
        [id: string]: Readonly<Project>;
    }>;
    readonly tags: Readonly<{
        [id: string]: Readonly<Tag>;
    }>;
    readonly notes: Readonly<{
        [id: string]: Readonly<PluginNote>;
    }>;
    readonly taskRepeatCfgs: Readonly<{
        [id: string]: Readonly<PluginTaskRepeatCfg>;
    }>;
...
export interface PluginAPI {
     ...
     */
    registerWorkContextHeaderButton(cfg: Omit<PluginWorkContextHeaderBtnCfg, 'pluginId'>): void;
    ...
    formatDate(date: Date | string | number, format: 'short' | 'medium' | 'long' | 'time' | 'datetime'): string;
...
export interface BatchUpdateError {
    ...
    type: 'VALIDATION_ERROR' | 'CIRCULAR_DEPENDENCY' | 'TASK_NOT_FOUND' | 'OUTSIDE_PROJECT' | 'UNKNOWN';
    message: string;
}
/**
 ...
 */
export declare enum PluginIframeMessageType {
